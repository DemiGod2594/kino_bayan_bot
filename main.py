...
from keyboards.admin_keyboard import keyboard_adm


@dp.message(Command("start"))
async def cmd_start(message: types.Message):
    await message.answer('''Привет!\nЯ кино-бот канала КиноБаян. Здесь собраны все фильмы, которые представлены у 
нас на канале. Отправьте цифру для получения ссылки на фильм''', reply_markup=keyboard_adm())
